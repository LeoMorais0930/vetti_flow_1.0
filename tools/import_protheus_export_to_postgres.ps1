...
Invoke-PsqlFile 'db\migrations\018_filter_blocked_sb1_products.sql'
Invoke-PsqlFile 'db\migrations\019_expose_stage_transfer_warehouses.sql'
Invoke-PsqlFile 'db\migrations\020_add_operator_pin_to_production_orders.sql'
Invoke-PsqlFile 'db\migrations\021_expose_all_sc2_columns.sql'
